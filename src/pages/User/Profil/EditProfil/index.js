...
import {StyleSheet, ToastAndroid, Text, View, Alert} from 'react-native';
...
const EditProfile = ({navigation}) => {
  ...
  const [fixNumPhone, setFixNumPhone] = useState('62')
  ...
  return (
    <View style={{flex: 1, backgroundColor: 'white'}}>
      ...
      <View style={{paddingHorizontal: 20, paddingVertical: 1, flexDirection:'row'}}>
        <Fumi
          label={'Nomor HP'}
          iconClass={FontAwesome5Icon}
          iconName={'phone'}
